...
To increase our precision, we exploit the information about the first shared k-mer position as it allows us to compute the potential overlap length between two reads, as shown in \Cref{fig:ovlen}.
