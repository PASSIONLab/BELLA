...
parse: occurrence-matrix.cpp hash_funcs.o fq_reader.o Buffer.o Kmer.o rmat
	$(COMPILER) -std=c++14 $(INCLUDE) -O3 -fopenmp -fpermissive edlib/src/edlib.cpp -o parse hash_funcs.o Kmer.o Buffer.o fq_reader.o occurrence-matrix.cpp -I edlib/include ${TOCOMPILE} ${LIBS}
