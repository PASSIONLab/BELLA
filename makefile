...
Buffer.o: kmercode/Buffer.c
	$(CC) -O3 -c -o Buffer.o kmercode/Buffer.c

rbounds.o: kmercode/rbounds.cpp
	$(CC) -O3 -c -o rbounds.o kmercode/rbounds.cpp

fq_reader.o: kmercode/fq_reader.c
	$(CC) -O3 -std=gnu99 -c -o fq_reader.o kmercode/fq_reader.c

hash_funcs.o: kmercode/hash_funcs.c
	$(CC) -O3 -c -o hash_funcs.o kmercode/hash_funcs.c
...
Kmer.o:	kmercode/Kmer.cpp
	$(COMPILER) -std=c++11 -O3 -c -o Kmer.o kmercode/Kmer.cpp
