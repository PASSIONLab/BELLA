...
parse: occurrence-matrix.cpp hash_funcs.o fq_reader.o Buffer.o Kmer.o rmat align.o DB.o QV.o
	$(COMPILER) -std=c++11 $(INCLUDE) -O3 -fopenmp -fpermissive -o parse hash_funcs.o Kmer.o Buffer.o fq_reader.o align.o DB.o QV.o occurrence-matrix.cpp ${TOCOMPILE} ${LIBS}
