...
void metricsDiBella(ifstream & th, ifstream & dbf, bool sim, int minOv, mmap_m & seqmap, uint32_t numth)
{
    bella_m metamap;
    bella_m::iterator it;
    int alignmentLength, ov;
    string cid, rid, cname, rname, nkmer, score, rev, cstart, cend, clen, rstart, rend, rlen;
