...
overlapop(const std::string& read1, const std::string& read2, const std::pair<int,bool>& pair1,
	const std::pair<int,bool>& pair2, const int kmerSize) {
	...
	// checking strand for HOPC version
	bool oriented = pair1.second == pair2.second;
	int begpH = pair1.first;
	int begpV = pair2.first;
